...
const Button = ({children, download, github, className}) => {
    ...
    const handleDownload = () => {
        ...
        link.href = "/CV - Valentino Araya.pdf"
        link.download = "CV - Valentino Araya.pdf"
        link.click()
    }
    ...
    return (
        <button className={`botonOriginal ${className}`} onClick={download && handleDownload}>
            <p>
                {
                    download &&
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.3rem" height="1.3rem" fill="currentColor" className="bi bi-download" viewBox="0 0 16 16">
